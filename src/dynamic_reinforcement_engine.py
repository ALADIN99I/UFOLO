    ...
    def _calculate_volatility_adjustment(self, symbol, current_market_data):
        ...
        try:
            ...
            if not validated_symbol:
                return 1.0  # Return neutral adjustment for invalid pairs
            
            if validated_symbol in current_market_data:
                spread = current_market_data[validated_symbol].get('spread', 0.0001)
