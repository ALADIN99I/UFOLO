...
class TraderAgent(Agent):
    ...
    def execute(self, research_consensus, open_positions, diversification_config=None):
        ...
        prompt = (
            ...
            "`{'action': 'new_trade'/'adjust_trade'/'close_trade', 'trade_id': <optional>, 'currency_pair': 'EURUSD', 'direction': 'BUY/SELL', 'entry_price': 1.0800, 'lot_size': 0.10}`.\n\n"
            "IMPORTANT: Use conservative position sizing - standard lot size should be 0.10 lots per trade.\n\n"
